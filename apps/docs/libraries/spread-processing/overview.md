...
> [ADR 0021](https://github.com/Harborline-Software/shipyard/blob/main/docs/adrs/0021-reporting-pipeline-policy.md) for the reporting pipeline policy.
...
No Sunfish equivalent exists today. [ADR 0021](https://github.com/Harborline-Software/shipyard/blob/main/docs/adrs/0021-reporting-pipeline-policy.md)
...
- [ADR 0021 — Reporting Pipeline Policy](https://github.com/Harborline-Software/shipyard/blob/main/docs/adrs/0021-reporting-pipeline-policy.md)
</content>
</invoke>