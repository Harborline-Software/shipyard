...
See [ADR 0007](https://github.com/Harborline-Software/shipyard/blob/main/docs/adrs/0007-bundle-manifest-schema.md) for the historical rationale and schema versioning policy.
...
- [ADR 0007 — Bundle Manifest Schema](https://github.com/Harborline-Software/shipyard/blob/main/docs/adrs/0007-bundle-manifest-schema.md)
</content>
</invoke>