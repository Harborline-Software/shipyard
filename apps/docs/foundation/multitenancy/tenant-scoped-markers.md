...
Bridge's shared `SunfishBridgeDbContext` (see [ADR 0015](https://github.com/Harborline-Software/shipyard/blob/main/docs/adrs/0015-module-entity-registration.md)) combines the markers with EF Core query filters.
