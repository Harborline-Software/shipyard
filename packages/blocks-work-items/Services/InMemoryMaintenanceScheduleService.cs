...
public sealed class InMemoryMaintenanceScheduleService : IMaintenanceScheduleService
{
    ...
    /// <inheritdoc />
    public async Task<IReadOnlyList<MaintenanceTask>> GenerateDueWorkItemsAsync(
