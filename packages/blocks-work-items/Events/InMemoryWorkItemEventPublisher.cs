...
/// <summary>
/// In-memory <see cref="IWorkItemEventPublisher"/> — accumulates
...
/// </summary>
public sealed class InMemoryWorkItemEventPublisher : IWorkItemEventPublisher
{
    ...
    /// <inheritdoc />
    public Task PublishWorkItemCreatedAsync(WorkItemCreatedEvent payload, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public Task PublishWorkItemAssignedAsync(WorkItemAssignedEvent payload, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(payload);
        _events.Enqueue(payload);
        return Task.CompletedTask;
    ...
    /// <inheritdoc />
    public Task PublishWorkItemCompletedAsync(WorkItemCompletedEvent payload, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(payload);
        _events.Enqueue(payload);
        return Task.CompletedTask;
