...
namespace Sunfish.Blocks.Reviews.DependencyInjection;
...
{
    /// <summary>
    /// Registers <see cref="IReviewsService"/> as a singleton backed by
    /// <see cref="InMemoryReviewsService"/>.
    ...
    public static IServiceCollection AddInMemoryReviews(this IServiceCollection services)
    {
