...
/// <param name="Kind">The type of response this item expects (see <see cref="ReviewItemKind"/>).</param>
...
public sealed record ReviewChecklistItem(
    ReviewChecklistItemId Id,
    string Prompt,
    ReviewItemKind Kind,
    bool Required);
