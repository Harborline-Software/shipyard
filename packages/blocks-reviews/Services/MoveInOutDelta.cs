...
/// <see cref="IReviewsService.GetMoveInOutDeltaAsync"/>; consumed by
/// security-deposit reconciliation downstream.
/// </summary>
/// <param name="UnitId">The unit this delta is computed for.</param>
/// <param name="MoveIn">The most-recent <see cref="ReviewTrigger.MoveIn"/> inspection on the unit.</param>
/// <param name="MoveOut">The most-recent <see cref="ReviewTrigger.MoveOut"/> inspection on the unit.</param>
