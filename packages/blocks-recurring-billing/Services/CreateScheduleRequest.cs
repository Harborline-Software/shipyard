...
/// <summary>Input model for creating a new <see cref="RecurringSchedule"/>.</summary>
/// <param name="LeaseId">
/// Opaque lease reference. See <see cref="RecurringSchedule.LeaseId"/> for the migration TODO.
/// </param>
