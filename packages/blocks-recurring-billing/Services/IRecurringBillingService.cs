...
public interface IRecurringBillingService
{
    ...
    /// <returns>The newly created <see cref="RecurringSchedule"/>.</returns>
    /// <exception cref="ArgumentException">
    /// Thrown when <paramref name="request"/> contains invalid data, e.g.
    /// <c>DueDayOfMonth</c> outside 1–28.
    /// </exception>
    ValueTask<RecurringSchedule> CreateScheduleAsync(CreateScheduleRequest request, CancellationToken ct = default);
    ...
    /// <see cref="BillingFrequency"/> and <see cref="RecurringSchedule.DueDayOfMonth"/>.
    /// </summary>
    ...
    /// </exception>
    ValueTask<Invoice> GenerateInvoiceAsync(RecurringScheduleId scheduleId, DateOnly periodStart, CancellationToken ct = default);
