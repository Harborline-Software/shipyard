using RcModels = global::Sunfish.Blocks.RecurringBilling.Models;
using Sunfish.Blocks.FinancialAr.Models;
using Sunfish.Blocks.FinancialLedger.Models;
using Sunfish.Blocks.People.Foundation.Models;
using Sunfish.Foundation.Assets.Common;

namespace Sunfish.Blocks.RecurringBilling.Migration;
...
/// <c>IRecurringBillingService</c> continues to work unchanged;
...
/// <c>IRecurringBillingService.GenerateInvoiceAsync</c> with a call to
