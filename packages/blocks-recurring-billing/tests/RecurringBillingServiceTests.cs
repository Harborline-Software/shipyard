...
public class RecurringBillingServiceTests
{
    private static InMemoryRecurringBillingService CreateService() => new();
    ...
    {
        var svc = CreateService();
        var missing = RecurringScheduleId.NewId();
    ...
    private static async Task<(RecurringSchedule Schedule, Invoice Invoice)> CreateScheduleAndInvoice(
        InMemoryRecurringBillingService svc,
