...
namespace Sunfish.Blocks.RecurringBilling.Localization;
...
/// enough to satisfy the cascade until <c>RecurringLedgerBlock</c> and the deferred
...
/// <c>Sunfish.Blocks.RecurringBilling.csproj</c> can be removed without expanding
/// the existing <c>RecurringLedgerBlock.razor</c> read-only surface mid-stream. When
