...
/// <summary>
/// Opaque identifier for an <see cref="Asset"/>. Mirrors the proven
/// <c>EquipmentId</c> shape from <c>blocks-property-equipment</c>: a
/// strongly-typed <see cref="string"/> wrapper with implicit conversions, a
/// <see cref="NewId"/> factory, and a JSON converter that serializes as a bare
/// string.
/// </summary>
